...
CREATE TABLE gdpr_tracking (
	 gtm_code varchar(255) NOT NULL DEFAULT '',
	 matomo_code text NOT NULL DEFAULT '',
	 gtm_heading varchar(255) NOT NULL DEFAULT '',
	 gtm_desc text NOT NULL DEFAULT '',
	 root_pid int(11) unsigned DEFAULT '0',
	 base_url varchar(255) NOT NULL DEFAULT '',
	 gtm_button_text text NOT NULL DEFAULT '',
	 gtm_enable_background_image int(11) NOT NULL DEFAULT '0',
	 gtm_background_image text NOT NULL DEFAULT '',
	 gtm_background_image_color varchar(255) NOT NULL DEFAULT '',
	 gtm_button_color varchar(255) NOT NULL DEFAULT '',
	 gtm_button_text_color varchar(255) NOT NULL DEFAULT '',
	 gtm_text_color varchar(255) NOT NULL DEFAULT '',
	 gtm_heading_color varchar(255) NOT NULL DEFAULT '',
	 gtm_button_shape varchar(255) NOT NULL DEFAULT '',
	 extension_title varchar(255) NOT NULL DEFAULT '',
	 extension_key varchar(255) NOT NULL DEFAULT '',
);
